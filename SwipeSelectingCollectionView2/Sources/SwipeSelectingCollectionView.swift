...
public class SwipeSelectingCollectionView: UICollectionView {
    ...
    lazy private var tapGestureRecognizer: UITapGestureRecognizer = {
        let tapGestureRecognizer = UITapGestureRecognizer(
            target: self,
            action: #selector(SwipeSelectingCollectionView.didTapGestureRecognizerChange(tapGestureRecognizer:)))
...
@objc public protocol SwipeUICollectionViewDelegate: UICollectionViewDelegate {
    @objc optional func collectionView(_ collectionView: UICollectionView, didSelectItemAtByTapped indexPath: IndexPath)
}
